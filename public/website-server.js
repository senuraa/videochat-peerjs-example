...
var privateKey  = fs.readFileSync('/etc/letsencrypt/live/peer.senuraa.com/privkey.pem', 'utf8');
var certificate = fs.readFileSync('/etc/letsencrypt/live/peer.senuraa.com/fullchain.pem', 'utf8');
